...
dcc.Markdown("""
	...
	"""),
html.Div([
	html.Img(src='https://github.com/jebibault/ProstateCancerSurvival/blob/master/figures/10yOSROC.png?raw=true', style={"width": "80%"})], style={"text-align":"center"}),
dcc.Markdown("""
	...
	"""),
html.Div([
	html.Img(src='https://github.com/jebibault/ProstateCancerSurvival/blob/master/figures/10yOSPrecisionRecall.png?raw=true', style={"width": "80%"})], style={"text-align":"center"}),
dcc.Markdown("""
	...
	"""),
html.Div([
	html.Img(src='https://github.com/jebibault/ProstateCancerSurvival/blob/master/figures/10yOS.png?raw=true', style={"width": "80%"})], style={"text-align":"center"}),
dcc.Markdown("""
	...
	"""),
html.Div([
	html.Img(src='https://github.com/jebibault/ProstateCancerSurvival/blob/master/figures/10yOSTreeExplainer.png?raw=true', style={"width": "80%"})], style={"text-align":"center"}),
]
