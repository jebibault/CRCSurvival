...
dcc.Markdown("""
	...
	"""),
html.Div([
	html.Img(src='https://github.com/jebibault/ProstateCancerSurvival/blob/master/figures/10yOSConfusionMatrix.png?raw=true')] style={"text-align":"center", 'width' : '80%'}),
dcc.Markdown("""
	#### ROC AUC
	...
	"""),
html.Div([
	html.Img(src='https://github.com/jebibault/ProstateCancerSurvival/blob/master/figures/10yOSROC.png?raw=true')] style={"text-align":"center", 'width' : '80%'}),
dcc.Markdown("""
	...
	"""),
html.Div([
	html.Img(src='https://github.com/jebibault/ProstateCancerSurvival/blob/master/figures/10yOSPrecisionRecall.png?raw=true')] style={"text-align":"center", 'width' : '80%'}),
dcc.Markdown("""
	...
	"""),
html.Div([
	html.Img(src='https://github.com/jebibault/ProstateCancerSurvival/blob/master/figures/10yOS.png?raw=true')] style={"text-align":"center", 'width' : '80%'}),
dcc.Markdown("""
	...
	"""),
html.Div([
	html.Img(src='https://github.com/jebibault/ProstateCancerSurvival/blob/master/figures/10yOSTreeExplainer.png?raw=true')] style={"text-align":"center", 'width' : '80%'}),
]
