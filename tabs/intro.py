...
layout = html.Div(
	html.P([
		...
		html.Br(),
		html.Br(),
		'In this trial, 76,693 men at 10 U.S. study centers were randomly assigned to receive either annual screening (38,343 subjects) or usual care as the control (38,350 subjects).',
		html.Br(),
		html.Br(),
		html.Br(),
