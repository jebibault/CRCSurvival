...
dcc.Markdown("""
	...
	| ROC AUC      | 94.31%    |  Area under the curve of true positive rate and the false positive rate at various thresholds |                                                                      
	| PR AUC       | 87.73%    |  Area under the curve of precision and recall at various thresholds.                          |
...
dcc.Markdown("""
	...
	|  Metric      |  Result   |  Definition					                                                               |
	|--------------|-----------|-----------------------------------------------------------------------------------------------|
	| Accuracy     | 98.29%    |  Number of correct predictions / total number of input samples                                |
	| Precision    | 85%       |  Number of correct positive predictions / number of positive samples                          |
	| Recall       | 77.86%    |  Number of correct positive results / number of all positive samples                          |
	| ROC AUC      | 95.34%    |  Area under the curve of true positive rate and the false positive rate at various thresholds |                                                           
	| PR AUC       | 81.93%    |  Area under the curve of precision and recall at various thresholds                           |
