...
html.P([
	...
	html.Br(),
	html.Br(),
	'Results of the trial were published in two articles:',
	html.Br(),
	...
	html.Br(),
	html.A("Miller EA et al., Lancet Gastroenterol Hepatol, 2019", href='https://www.ncbi.nlm.nih.gov/pubmed/30502933', target="_blank", style={'font-weight': 'bold', 'color': '#820000', 'text-decoration': 'none'}),
	html.Br(),
	html.Br(),
	html.Br(),
]),
